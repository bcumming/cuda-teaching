...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}[fragile]{Exercise: Getting Ready}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %\todo{update for new system}
    \begin{enumerate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item what are the benefits over using \lst{cudaMalloc} and \lst{malloc} directly?
        ...
        \begin{itemize}
            \item see \lst{copy_to_device} \& \lst{copy_to_host}
