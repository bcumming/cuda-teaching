...
\vspace{-7pt}
%----------------------------
        \begin{code}{scan : e.g. prefix or partial sum}
            \begin{lstlisting}[style=boxcudatiny]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %\begin{info}{}
        ...
        \emph{Note}: there are some low level intrinsics for cooperation between threads in the same \emph{warp}
        \begin{itemize}
            \item warp votes and shuffles
            \item still restricted to the same thread block
        \end{itemize}
