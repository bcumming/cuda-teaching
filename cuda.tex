...
\newcommand{\lst}[1]{\colorbox{white!10!black}{\lstinline!#1!}}
...
%\input{cuda_introduction.tex}
%\input{cuda_api.tex}
%\input{cuda_threads.tex}
%\input{cuda_blocks.tex}
\input{cuda_local.tex}
\input{cuda_async.tex}
%\input{cuda_todo.tex}
