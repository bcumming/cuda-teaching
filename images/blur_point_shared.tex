...
\node[lab] (inlab) [draw, left = 1cm of inm2] {in};
...
\node[lab] (bufflab) [draw, below = 1cm of inlab] {shared};
\node[lab] (outlab)  [draw, below = 1cm of bufflab] {out};
...
\path[pil,->,red!50!yellow] (buff.south)  edge (out.north);
\path[pil,->,red!50!yellow] (buffm1.south)  edge (out.north);
\path[pil,->,red!50!yellow] (buffp1.south)  edge (out.north);
