...
\node[lab] (inlab) [fill=blue!20, left = 1cm of inm2] {in};

\node[noutm]  (outm1) [below = 1cm of inm1] {\vout{i-1}};
\node[nout]   (out)   [below = 1cm of in]   {\vout{i}};
\node[noutm]  (outp1) [below = 1cm of inp1] {\vout{i+1}};

\node[lab] (outlab) [fill=green!20, below = 1cm of inlab] {out};

\path[pil,->,white!80!black] (inm2.south)  edge (outm1.north);
\path[pil,->,white!80!black] (inm1.south)  edge (outm1.north);
\path[pil,->,white!80!black] (in.south)    edge (outm1.north);

\path[pil,->,white!80!black] (inp2.south)  edge (outp1.north);
\path[pil,->,white!80!black] (inp1.south)  edge (outp1.north);
\path[pil,->,white!80!black] (in.south)    edge (outp1.north);

\path[pil,->,green!50!black] (inm1.south)  edge (out.north);
\path[pil,->,green!50!black] (in.south)  edge (out.north);
\path[pil,->,green!50!black] (inp1.south)  edge (out.north);
