...
\node[res] (one1) [below = 1cm of core2] {\huge\textbf{+}};
\node[res] (one2) [below = 1cm of core4] {\huge\textbf{+}};
\node[res] (one3) [below = 1cm of core6] {\huge\textbf{+}};
...
\node[res] (two1) [below = 1cm of one2] {\huge\textbf{+}};
